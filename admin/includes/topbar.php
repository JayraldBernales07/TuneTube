    ...
    <div class="profile d-flex align-items-center">
        ...
        <div class="profile">
          ...
          <div class="user">
            <!-- Profile Picture -->
            <div class="left">
              <img src="img/profile.png" alt="Profile Picture" class="rounded-circle">
            </div>

            <!-- Right Side with Logout -->
            <div class="right">
              <a href="logout.php" data-bs-toggle="modal" data-bs-target="#logoutModal" class="logout-btn text-decoration-none">Log out</a>
            </div>
          </div>
        </div>
    </div>
